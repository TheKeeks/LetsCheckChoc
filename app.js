...
async function loadSurfLog() {
  try {
    // Wait for Firebase auth to settle before querying (avoids querying with anonymous UID)
...
async function loadLogsFromFirebase() {
  ...
  // Don't query Firestore with an anonymous UID — data is only stored under real user IDs
